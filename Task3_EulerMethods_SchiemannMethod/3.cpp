...
{	
	...
	cout<<"Введите значения:"<<endl<<endl;
...
void Yavnui_metod_Eilera(int n,double *yo,double a, double k)
{
	cout<<"YavniiEiler"<<endl;
	ofstream outf;
	outf.open("YavniiEiler.txt");
	...
	cout<<setw(15)<<d<<setw(15)<<t<<setw(15)<<y[0]<<setw(15)<<y[1]<<setw(15)<<y[2]<<endl;
	cout<<"============================================================================"<<endl;
		cout<<"iter = "<<nit<<endl;
		cout<<"Y1 = "<<y[0]<<endl;
		cout<<"Y2 = "<<y[1]<<endl;
